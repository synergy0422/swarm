...
must_haves:
  truths:
    ...
    - "Parameters --session, --workdir, --left-ratio, --codex-cmd work correctly"
...
<task type="auto">
  ...
  <action>
    ...
    3. Define defaults:
       ...
       - WORKDIR: from SWARM_WORKDIR env var, fallback to /home/user/projects/AAA/swarm
    ...
    6. Implement 5-pane layout using tmux commands:
    ...
    7. Send startup commands to each pane:
  ...
  <done>
    ...
    - Parameter parsing for --session, --workdir, --left-ratio, --codex-cmd
...
grep -E "getopts|--session|--workdir|--left-ratio|--codex-cmd" scripts/swarm_layout_5.sh
...
- [ ] Supports --session, --workdir, --left-ratio, --codex-cmd parameters
